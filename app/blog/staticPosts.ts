...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "Is After Dark Cannabis the Right Weed Dispensary in York for Your Visit?",
    "seoTitle": "After Dark Cannabis Weed Dispensary in York | Visit Guide",
    "seo_title": "After Dark Cannabis Weed Dispensary in York | Visit Guide",
    "metaDescription": "Plan a York visit to After Dark Cannabis with store-page checks, menu categories, and practical next steps for adults 19+.",
    "meta_description": "Plan a York visit to After Dark Cannabis with store-page checks, menu categories, and practical next steps for adults 19+.",
    "h1": "Is After Dark Cannabis the Right Weed Dispensary in York for Your Visit?",
    "excerpt": "A practical York visit guide for adults 19+ checking After Dark Cannabis.",
  ...
  },
  {
    ...
    "title": "After Dark Cannabis Flower Guide: Budget, Premium and Exotic Sections",
    "seoTitle": "After Dark Cannabis Flower Guide | York Budget to Exotic",
    "seo_title": "After Dark Cannabis Flower Guide | York Budget to Exotic",
    "metaDescription": "Compare After Dark Cannabis flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "meta_description": "Compare After Dark Cannabis flower sections including Budget, AA, AAA+, Premium, and Exotic with current-menu checks and natural value wording.",
    "h1": "After Dark Cannabis Flower Guide: Budget, Premium and Exotic Sections",
    "excerpt": "A clear flower guide for After Dark Cannabis, from cheap weed and budget weed searches to premium flower and exotic flower browsing.",
    "authorName": "Mara Moon",
    "authorHandle": "@MaraAfterDark",
    "authorRole": "House Writer",
    "author": "Mara Moon",
  ...
  },
  {
    ...
    "title": "After Dark Cannabis Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "seoTitle": "After Dark Cannabis Menu Guide | York Weed Store Categories",
    "seo_title": "After Dark Cannabis Menu Guide | York Weed Store Categories",
    "metaDescription": "Use this After Dark Cannabis menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "meta_description": "Use this After Dark Cannabis menu guide to browse flower sections, pre-rolls, edibles, THC vapes, concentrates, accessories, and store details before visiting.",
    "h1": "After Dark Cannabis Menu Guide: Flower, Pre-Rolls, Edibles, THC Vapes and More",
    "excerpt": "A practical York menu guide for After Dark Cannabis, with natural category paths for adults 19+.",
    "authorName": "Nico Night",
    "authorHandle": "@NicoAfterHours",
    "authorRole": "House Writer",
    "author": "Nico Night",
