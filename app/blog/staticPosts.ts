...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a After Dark Cannabis Visit Without Guessing",
    "seoTitle": "After Dark Cannabis Visit Guide | Weed Dispensary in York",
    "seo_title": "After Dark Cannabis Visit Guide | Weed Dispensary in York",
    "metaDescription": "Plan a Jane St in York visit to After Dark Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a Jane St in York visit to After Dark Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a After Dark Cannabis Visit Without Guessing",
    "excerpt": "A practical visit guide for After Dark Cannabis, written for shoppers who want the next step without the runaround.",
  ...
  },
  {
    ...
    "title": "How to Compare After Dark Cannabis Flower Without Guessing",
    "seoTitle": "After Dark Cannabis Flower Guide | Budget to Exotic",
    "seo_title": "After Dark Cannabis Flower Guide | Budget to Exotic",
    "metaDescription": "Compare After Dark Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare After Dark Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare After Dark Cannabis Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at After Dark Cannabis.",
    "authorName": "Mara Moon",
    "authorHandle": "@MaraAfterDark",
    "authorRole": "House Writer",
    "author": "Mara Moon",
  ...
  },
  {
    ...
    "title": "How to Shop the After Dark Cannabis Menu Like a Pro",
    "seoTitle": "After Dark Cannabis Menu Guide | York Weed Store",
    "seo_title": "After Dark Cannabis Menu Guide | York Weed Store",
    "metaDescription": "Shop the After Dark Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the After Dark Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the After Dark Cannabis Menu Like a Pro",
    "excerpt": "A natural guide to shopping the After Dark Cannabis menu without turning the visit into a guessing game.",
    "authorName": "Nico Night",
    "authorHandle": "@NicoAfterHours",
    "authorRole": "House Writer",
    "author": "Nico Night",
