...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at After Dark" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="MJ01" />
      <input type="hidden" name="StoreName" value="After Dark Cannabis" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at After Dark?</span>
