...
export const SEO_PAGES: SeoPageData[] = [
  {
    ...
    title: "York Weed Dispensary on Jane Street — After Dark Cannabis | Open 24 Hours",
    metaDescription: "24-hour York dispensary at 1664 Jane Street, just south of Lawrence. Flower from $3/g. Call +1 (437) 524-9344. Adults 19+.",
    h1: "York Weed Dispensary on Jane Street — Open 24 Hours",
    icon: "✨",
    heroTagline: "1664 Jane Street · Open 24 Hours · Walk-In Welcome",
    banner: "/banners/after_dark_welcome_banner.webp",
    sections: [
      { heading: "A 24-Hour Cannabis Store on Jane Street", body: "After Dark Cannabis is the walk-in York dispensary at 1664 Jane Street, York, ON M9N 2S1, just south of Lawrence Avenue West. The counter is open 24 hours a day. The homepage is the NAP hub for address, phone, map, and directions." },
      ...
      { heading: "Late-night Jane Street walk-in", body: "Night-shift neighbours and late 35 Jane riders use the same York door. Confirm hours on the 24-hour York page and bring government photo ID. Adults 19+ only." },
    ],
    faqs: [
      { q: "Where is After Dark Cannabis located?", a: "After Dark Cannabis is at 1664 Jane Street, York, ON M9N 2S1." },
      { q: "What are the store hours?", a: "After Dark Cannabis is open 24 hours a day, seven days a week." },
      { q: "Is the York dispensary open now?", a: "Yes. The Jane Street counter stays open overnight. Call +1 (437) 524-9344 if one listed item is the reason for the trip." },
  ...
  },
  {
    ...
    title: "Dispensary Near Me in York — 24-Hour Jane Street | After Dark Cannabis",
    metaDescription: "Looking for a dispensary near you in York? After Dark Cannabis is open 24 hours at 1664 Jane Street. Call +1 (437) 524-9344. Adults 19+.",
    h1: "Dispensary Near Me in York — Jane Street, Open 24 Hours",
    icon: "🗺️",
    heroTagline: "1664 Jane Street · Open 24 Hours · Browse the Menu",
    banner: "/banners/after_dark_welcome_banner.webp",
    sections: [
      { heading: "Find After Dark Cannabis in York", body: "After Dark Cannabis is the walk-in at 1664 Jane Street, York, ON M9N 2S1, just south of Lawrence Avenue West. Use the homepage for address, phone, map, and directions." },
      ...
      { heading: "Open Around the Clock", body: "The Jane Street store is open 24 hours a day, seven days a week. Walk-in shopping is welcome, including after midnight." },
    ],
    faqs: [
      { q: "Where is the store?", a: "After Dark Cannabis is at 1664 Jane Street in York." },
      { q: "What are the hours?", a: "The store is open 24 hours a day." },
      { q: "Is there a 24-hour dispensary near me in York?", a: "After Dark Cannabis at 1664 Jane Street is open 24 hours. Call +1 (437) 524-9344 before travelling for one exact item." },
