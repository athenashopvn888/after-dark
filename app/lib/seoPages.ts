...
export const SEO_PAGES: SeoPageData[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "After Dark Cannabis is more than just a flower shop. We carry a comprehensive selection of cannabis edibles (gummies, chocolates, baked goods), vape pens and disposable vapes, concentrates (shatter, wax, hash, diamonds, live resin), pre-rolled joints, magic mushrooms, native cigarettes, rolling papers, and accessories. Our live digital menu at afterdarkcannabis.com updates in real time so you always know exactly what's in stock before you make the trip.",
      },
      {
      ...
      },
      {
        ...
        body: "Every purchase at After Dark Cannabis comes with our signature promotions. Our Buy 2g Get 1g FREE deal applies to every single tier — you always get a bonus gram. Our top three tiers (Exotic, Premium, and AAA+) also qualify for Buy 3g Get 3g FREE, effectively doubling your order. Combined with our already competitive pricing, After Dark Cannabis offers some of the best cannabis value in York, Toronto, and the surrounding area.",
      },
      {
    ...
    faqs: [
      ...
      { q: "What cannabis products does After Dark Cannabis carry?", a: "We carry 200+ strains of cannabis flower across 5 quality tiers (Exotic, Premium, AAA+, AA, Budget), plus edibles, vapes, concentrates, pre-rolls, magic mushrooms, native cigarettes, and accessories. Our menu updates in real time online." },
      { q: "What is the cheapest weed at After Dark Cannabis?", a: "Our Budget tier starts at $3/g with value ounces from $40. Our AA tier is $4/g. Every tier includes our Buy 2g Get 1g FREE promotion, making our prices even more competitive." },
...

  {
    ...
    metaDescription: "Looking for cheap weed in York? After Dark Cannabis has budget flower from $3/g, ounces from $40, and Buy 2g Get 1g FREE promos. Open 24 hours at 1664 Jane St.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Every tier at After Dark Cannabis comes with our signature Buy 2g Get 1g FREE promotion — meaning you always get a free gram with every purchase. Our top three tiers (Exotic, Premium, AAA+) also offer Buy 3g Get 3g FREE, effectively doubling your order. When you combine our already low prices with these promos, After Dark Cannabis delivers the best cannabis value in York. A $15 AAA+ 3g purchase actually gets you 3g of flower — that's just $5/g for THC 30%+ cannabis.",
      },
      {
      ...
      },
      {
        ...
        body: "Budget: $3/g — $40/oz. AA: $4/g — $90/oz. AAA+: $5-$6/g — $100/oz. Premium: $7-$10/g. Exotic: $10-$12/g. Every tier includes Buy 2g Get 1g FREE. Top tiers include Buy 3g Get 3g FREE. These are some of the lowest prices you'll find at any dispensary in York, Weston, Mount Dennis, Etobicoke, or North York.",
      },
    ],
    faqs: [
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "After Dark Cannabis offers a wider selection and more competitive pricing than most local Peel options. You'll find over 200 strains across five quality tiers — from ultra-rare Exotic genetics (THC 35-39%) to affordable Budget flower at just $3/g. Our Buy 2g Get 1g FREE promotion applies to every tier, and our top three tiers offer Buy 3g Get 3g FREE. With prices starting at $3/g and ounces from $40, After Dark Cannabis delivers value that's worth the short drive from Mississauga.",
      },
      {
      ...
      },
      {
        ...
        body: "When you make the trip up to York, make it count. After Dark Cannabis carries a full selection including 200+ flower strains, edibles, vape pens, disposable vapes, concentrates (shatter, wax, hash, live resin), pre-rolled joints, magic mushrooms, native cigarettes, and accessories. Check our live online menu at afterdarkcannabis.com before you visit to see exactly what's in stock.",
      },
    ],
    faqs: [
      ...
      { q: "Is it worth driving from Mississauga for cannabis?", a: "Absolutely. After Dark Cannabis offers 200+ strains, prices starting at $3/g, and promotions like Buy 2g Get 1g FREE that make the short drive incredibly worthwhile." },
      ...
      { q: "What's the cheapest weed near Mississauga?", a: "After Dark Cannabis has Budget flower from $3/g and value ounces from $40. With our Buy 2g Get 1g FREE promo, these are some of the best prices in the Greater Toronto Area." },
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "What sets After Dark Cannabis apart from other York dispensaries is our combination of selection, pricing, and convenience. We carry 200+ strains across five clear quality tiers — no confusing markups, no inconsistent pricing. Our Buy 2g Get 1g FREE promotion applies to every tier, every purchase. And unlike most dispensaries that close at midnight, we're open 24 hours a day, 7 days a week. Whether you need flower, edibles, vapes, or concentrates at any hour, After Dark Cannabis is here.",
      },
      {
