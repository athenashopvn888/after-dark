...
export const gbpLocation = {
  ...
  hours: ["Open 24 Hours"],
  seoTitle: "Weed Dispensary in York | After Dark Cannabis",
  metaDescription: "After Dark Cannabis is open 24 hours at 1664 Jane Street in York. Adults 19+ can explore flower tiers, pre-rolls, edibles, vapes and concentrates.",
