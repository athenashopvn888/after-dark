...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at After Dark Cannabis, York. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. After Dark Cannabis stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 1664 Jane St, York.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    faqs: [
      ...
      { q: "Are your cigarette prices competitive?", a: "Absolutely. We offer some of the best cigarette prices in the ByWard Market area of York." },
    ],
  },
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at After Dark Cannabis, York.",
    seoDescription: "After Dark Cannabis carries a curated selection of magic mushrooms and specialty products in York. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 1664 Jane St for our full selection.",
    faqs: [
