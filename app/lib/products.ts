...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoDescription: "The edibles menu at After Dark Cannabis is for walk-in customers at 1664 Jane Street in York. Gummies, chocolates, and baked options appear in the grid when they are on the current sheet. Read this static section if you want the page to make sense without the grid loading. Edibles are a different pace than flower. Start low if you are new, wait before taking more, and do not drive impaired. Staff can explain the posted milligram labels and pack sizes, but they cannot give medical advice. This page supports York and Weston searches for weed edibles without pretending the store is in another city. For drop-off, use the York delivery URL. For the physical counter, stay on the York dispensary hub. Check the live grid for current names, package details, and prices, then call +1 (437) 524-9344 if one exact item is the reason for your trip. Adults 19+ with valid government photo ID.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoDescription: "Looking for THC vapes at a York dispensary that never closes? After Dark Cannabis keeps disposable vapes and 510-style carts behind the Jane Street counter at 1664 Jane St. This category page lists the formats currently posted on the York menu, while nicotine vapes remain in a separate category. Walk-in shoppers from Weston, Mount Dennis, and Lawrence West use this page to compare the current product name, format, listed potency, and posted price before coming in. The page does not quote medical outcomes or promise that a rotating SKU will remain available. York vape shoppers often arrive after midnight because the store is open 24 hours. If you need one exact item, call +1 (437) 524-9344 so the counter can check before you travel. Adults 19+ with valid government photo ID. Use the York dispensary hub for the physical counter, or the city-specific delivery pages for a drop-off request. Flower tiers, concentrates, and edibles each have their own menu pages.",
    faqs: [
  ...
  CONCENTRATES: {
    ...
    seoDescription: "Concentrates at After Dark Cannabis — including shatter, wax, hash, diamonds, and live resin when posted — sit in their own York menu category. The Jane Street store at 1664 Jane St is open 24 hours, which matters for late-night shoppers who do not want a standard retail window. Use the grid for current names, formats, listed strength, package details, and posted prices. This static section makes clear that the page is about concentrates at a York walk-in dispensary, not a generic product dump or a permanent inventory promise. Hardware and accessories are listed separately. Staff can clarify the current label and texture; this page does not make health claims or provide medical advice. Call +1 (437) 524-9344 if you are coming from Mount Dennis, Weston, Lawrence West, or Keelesdale for one specific extract. Adults 19+ with valid government photo ID. Use the York walk-in hub for store information and the York delivery page for a drop-off request.",
    faqs: [
