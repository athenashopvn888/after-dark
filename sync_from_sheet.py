"""
After Dark Cannabis - Auto Sync from Google Sheets
==========================================
...
a filtered menu for After Dark Cannabis (ALC01).
...
def main():
    print("=" * 60)
    print(f"  After Dark Cannabis - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
